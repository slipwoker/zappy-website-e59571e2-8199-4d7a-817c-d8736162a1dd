document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    const animatableElements = document.querySelectorAll(
      ...
      '.feature-card, .pricing-card, .testimonial, .team-member, ' +
    ...
    animatableElements.forEach(function (el, index) {
      if (!el.hasAttribute('data-delay') && el.classList.contains(OBSERVE_CLASS)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e59571e2-8199-4d7a-817c-d8736162a1dd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e59571e2-8199-4d7a-817c-d8736162a1dd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e59571e2-8199-4d7a-817c-d8736162a1dd';
